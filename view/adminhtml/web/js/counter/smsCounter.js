...
(function () {
    ...
    window.SmsCounter = SmsCounter = (function () {
        ...
        SmsCounter.count = function (text) {
            let encoding, length, messages, perMessage, remaining;
            ...
            perMessage = this.messageLength[encoding];
            if (length > perMessage) {
                perMessage = this.multiMessageLength[encoding];
            }
            messages = Math.ceil(length / perMessage);
            ...
            return {
                encoding: encoding,
                length: length,
                per_message: perMessage, // eslint-disable-line
                remaining: remaining,
                messages: messages
            };
        };
