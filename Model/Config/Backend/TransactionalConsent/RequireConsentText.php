...
class RequireConsentText extends Value
{
    ...
    /**
     * Require transactional consent text before enabling transactional SMS consent.
     *
     * @return Value
    ...
    public function beforeSave()
    {
        ...
        if (!$this->isTransactionalConsentTextSetOrInherited()) {
    ...
    /**
     * Check if transactional consent text is set or inherited.
     *
     * @return bool
     */
    private function isTransactionalConsentTextSetOrInherited(): bool
    {
