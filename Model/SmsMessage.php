...
use Dotdigitalgroup\Sms\Model\ResourceModel\SmsMessage as SmsResource;
...
class SmsMessage extends AbstractModel implements SmsMessageInterface
{
    ...
    {
        return $this->numberUtility->returnMobileNumberFromStorage((string) $this->getData(self::PHONE_NUMBER));
    }
